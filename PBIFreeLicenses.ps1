...
$UserPBIProLicensesCSV = $BasePath + "I_BI_PBILICENCASFREE.csv"
...
#>
# Service Plan ID referente as licenças FREE do Power BI
$PBIFreeServicePlanID = "2049e525-b859-401b-b2a0-e0a31c4b1fe4"

# Recupere e exporte usuários com licenças profissionais com base no Service Plan ID do Power BI Free ($PBIFreeServicePlanID)
# Cada linha representa um plano de serviço para um usuário específico. Este detalhe da licença é filtrado apenas para a ID do plano de serviço do Power BI FREE.
